...
NV_CPP  ?= /usr/local/gcc-4.7.2/bin/cpp
NV_GCC  ?= /usr/local/gcc-4.7.2/bin/gcc
NV_CXX  ?= /usr/local/gcc-4.7.2/bin/g++
NV_PERL ?= perl
NV_JAVA ?= java
NV_SYSTEMC ?= /usr/local/systemc-2.3.0/
NV_PROJ ?= nv_small 
NV_PYTHON 	?= python
NV_VERDI_HOME ?= /opt/EDA/synopsys/verdi/K-2015.09
NV_NOVAS_HOME ?= /opt/EDA/synopsys/verdi/K-2015.09
NV_VCS_HOME   ?= /opt/EDA/synopsys/vcs/J-2014.12-SP3
